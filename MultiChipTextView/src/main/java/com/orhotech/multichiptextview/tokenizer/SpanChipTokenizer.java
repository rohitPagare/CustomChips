package com.orhotech.multichiptextview.tokenizer;
...
import com.orhotech.multichiptextview.chip.ChipCreator;
...
public class SpanChipTokenizer <C extends Chip> implements ChipTokenizer{
    ...
    @NonNull
    private final ChipCreator<C> mChipCreator;
    @NonNull
    private final Class<C> mChipClass;

    private final Comparator<Pair<Integer, Integer>> mReverseTokenIndexesSorter = (lhs, rhs) -> rhs.first - lhs.first;
    ...
    public void terminateAllTokens(Editable text) {
        ...
        unterminatedTokens.sort(mReverseTokenIndexesSorter);
